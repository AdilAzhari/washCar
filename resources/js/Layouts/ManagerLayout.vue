...
const navigation = [
  ...
  { name: 'All Branches Analytics', href: 'manager.analytics.all-branches', icon: Building2 },
  { name: 'Appointments', href: 'manager.appointments.index', icon: Calendar },
  { name: 'Queue', href: 'manager.queue.index', icon: ListOrdered },
  { name: 'Bays', href: 'manager.bays.index', icon: Waves },
  { name: 'Customers', href: 'manager.customers.index', icon: Users },
  { name: 'Packages', href: 'manager.packages.index', icon: Package },
  { name: 'Staff', href: 'manager.staff.index', icon: UsersRound },
  { name: 'Inventory', href: 'manager.inventory.index', icon: PackageOpen },
  { name: 'Transactions', href: 'manager.transactions.index', icon: Receipt },
    ...
    >
      <div class="flex flex-col h-full">
        ...
        <div class="flex items-center gap-2 px-6 py-6 border-b">
          <Link :href="route('manager.dashboard')" class="flex items-center gap-2">
        ...
        <div class="p-4 border-t">
          <div class="flex items-center gap-3 px-3 py-2 rounded-lg mb-2">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-xs text-muted-foreground truncate">Manager</p>
            </div>
          </div>
          <Link
